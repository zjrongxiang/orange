(function (L) {
    var _this = null;
    L.SignatureAuthHeader = L.SignatureAuthHeader || {};
    _this = L.SignatureAuthHeader = {
        data: {
        },

        init: function () {
            L.Common.loadConfigs("signature_auth_header", _this, true);
            _this.initEvents();
        },

        initEvents: function () {
            L.Common.initRuleAddDialog("signature_auth_header", _this);//添加规则对话框
            L.Common.initRuleDeleteDialog("signature_auth_header", _this);//删除规则对话框
            L.Common.initRuleEditDialog("signature_auth_header", _this);//编辑规则对话框
            L.Common.initRuleSortEvent("signature_auth_header", _this);

            L.Common.initSelectorAddDialog("signature_auth_header", _this);
            L.Common.initSelectorDeleteDialog("signature_auth_header", _this);
            L.Common.initSelectorEditDialog("signature_auth_header", _this);
            L.Common.initSelectorSortEvent("signature_auth_header", _this);
            L.Common.initSelectorClickEvent("signature_auth_header", _this);
            ...
            L.Common.initViewAndDownloadEvent("signature_auth_header", _this);
            L.Common.initSwitchBtn("signature_auth_header", _this);//redirect关闭、开启
            L.Common.initSyncDialog("signature_auth_header", _this);//编辑规则对话框
        },
